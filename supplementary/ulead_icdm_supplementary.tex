...
\begin{document}
	...
	The encoder is trained for 20 epochs using Adam with no weight decay and a batch size of 1024, with the learning rate scheduled from $5\times10^{-4}$ to $10^{-6}$. 
